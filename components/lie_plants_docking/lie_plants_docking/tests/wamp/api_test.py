...
class RunPlantsDocking(WAMPUnitTestBase):
    ...
    def onJoin(self, details):
        ...
        res = yield self.call(u'liestudio.plants_docking.run_docking', protein, ligand, config=config)
        ...
        for s in means:
            structure = yield self.call(u'liestudio.plants_docking.get', os.path.join(res['dir'], s))
