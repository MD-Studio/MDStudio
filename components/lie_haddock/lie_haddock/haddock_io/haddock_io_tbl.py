...
"""
file: haddock_io_tbl.py

Haddock specific import and export of CNS restraints .tbl files
Derived from:

https://github.com/haddocking/haddock-tools/tree/master/haddock_tbl_validation
"""
