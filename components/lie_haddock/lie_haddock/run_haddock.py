...
if 'main' == __name__:
    ...
    if args.list_users:
        ...
        if len(projects):
            ...
            print
            "No recent projects for the specified user"
    elif args.url:
        try:
        ...
        try:
            ...
            print
            "ERROR: User name or password not correct or not known"
            sys.exit(0)
        ...
        f.close()
        print
        "Parameters saved in: {}".format(output)
    elif args.download:
        try:
        ...
        f.close()
        print
        "Download finished successfully at: {}".format(output)
    elif args.run:
        print
        "####\nLaunching HADDOCK...\n####"
        # print "Project name: {}".format("default" if not args.run[1] else args.run[1])
        print
        "Parameter file: {}".format(args.run[0])
