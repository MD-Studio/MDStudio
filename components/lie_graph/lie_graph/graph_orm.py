...
class GraphORM(object):
    ...
    def map_node(self, cls, node_attr=None, **kwargs):
        ...
        matching_rules = {}
        if node_attr:
            assert type(node_attr) == dict, TypeError('node_attr not of type dictionary')
    ...
    def map_edge(self, cls, edge_attr=None, **kwargs):
        ...
        matching_rules = {}
        if edge_attr:
            assert type(edge_attr) == dict, TypeError('edge_attr not of type dictionary')
