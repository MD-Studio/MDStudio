...
JSONSchemaORMDraft07.map_node(Email, format='email')
JSONSchemaORMDraft07.map_node(Email, format='idn-email')
JSONSchemaORMDraft07.map_node(DateTime, format='date-time')
JSONSchemaORMDraft07.map_node(Date, format='date')
JSONSchemaORMDraft07.map_node(Time, format='time')
JSONSchemaORMDraft07.map_node(IP4Address, format='ipv4')
JSONSchemaORMDraft07.map_node(IP6Address, format='ipv6')
JSONSchemaORMDraft07.map_node(Hostname, format='hostname')
JSONSchemaORMDraft07.map_node(Hostname, format='idn-hostname')
JSONSchemaORMDraft07.map_node(URI, format='uri')
