...
The design of the lie_system.config module mimics that of Pythons well known
...
.. code-block:: python
    ...
    import json
    import lie_system.config

    config = lie_system.config.get_config()
