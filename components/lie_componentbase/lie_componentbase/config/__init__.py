...
The design of the lie_componentbase.config module mimics that of Pythons well known
...
.. code-block:: python
    ...
    import json
    import lie_componentbase.config

    config = lie_componentbase.config.get_config()
...
__module__ = 'lie_componentbase.config'
