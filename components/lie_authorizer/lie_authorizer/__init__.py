...
"""
package: lie_authorizer

LIEStudio authorization management component
"""

import os

__module__ = 'lie_authorizer'
...
from .wamp_services import AuthorizerWampApi

# Define module public API
wampapi = AuthorizerWampApi
