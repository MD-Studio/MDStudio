...
class TestSplineFilter(unittest2.TestCase):
    ...
    def test_liemdframe_filtersplines_filter(self):
        """
    ...
    def test_liemdframe_filtersplines_plot(self):
        """
    ...
    def test_liemdframe_filtersplines_average(self):
        """
