...
# -*- coding: utf-8 -*-
#
# LIEStudio documentation build configuration file, created by
# sphinx-quickstart on Fri Aug 19 16:31:05 2016.
#
...
htmlhelp_basename = 'LIEStudiodoc'
...
latex_documents = [
    (master_doc, 'LIEStudio.tex', 'LIEStudio Documentation',
     'LIEStudio', 'manual'),
]
...
man_pages = [
    (master_doc, 'liestudio', 'LIEStudio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LIEStudio', 'LIEStudio Documentation',
     author, 'LIEStudio', 'One line description of project.',
     'Miscellaneous'),
]
