...
echo '    liedocs         Compile the documentation'
echo '    liecheck        Run several static analysis tools against the codebase'
echo '    liepep8         Fix all pep8 style issues automatically'
echo ''
echo ''