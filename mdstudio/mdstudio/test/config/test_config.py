...
from mdstudio.config.io import flatten_nested_dict
...
class ConfigHandlerTests(unittest.TestCase):
    ...
    _settings_json = os.path.join(os.path.dirname(_currpath), 'files/handler_test.json')
    ...
    def setUp(self):
        ...
        self.data = flatten_nested_dict(json.load(open(self._settings_json)))
